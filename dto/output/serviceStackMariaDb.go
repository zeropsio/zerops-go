...
type ServiceStackMariaDb struct {
	...
	Ports                              ServiceStackMariaDbPorts           `json:"ports"`
	...
	ConnectedStacks                    ServiceStackMariaDbConnectedStacks `json:"connectedStacks"`
	UserData                           ServiceStackMariaDbUserData        `json:"userData"`
...
type ServiceStackMariaDbPorts []ServicePort

func (dto ServiceStackMariaDbPorts) MarshalJSON() ([]byte, error) {
	if dto == nil {
		return []byte("[]"), nil
	}
...
type ServiceStackMariaDbConnectedStacks []ServiceStackConnectedServiceStack

func (dto ServiceStackMariaDbConnectedStacks) MarshalJSON() ([]byte, error) {
	if dto == nil {
		return []byte("[]"), nil
	}
...
type ServiceStackMariaDbUserData []UserDataLight

func (dto ServiceStackMariaDbUserData) MarshalJSON() ([]byte, error) {
	if dto == nil {
		return []byte("[]"), nil
	}
