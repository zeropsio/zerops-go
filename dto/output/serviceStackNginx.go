...
type ServiceStackNginx struct {
	...
	Ports                              ServiceStackNginxPorts             `json:"ports"`
	...
	ConnectedStacks                    ServiceStackNginxConnectedStacks   `json:"connectedStacks"`
	UserData                           ServiceStackNginxUserData          `json:"userData"`
...
type ServiceStackNginxPorts []ServicePort

func (dto ServiceStackNginxPorts) MarshalJSON() ([]byte, error) {
	if dto == nil {
		return []byte("[]"), nil
	}
...
type ServiceStackNginxConnectedStacks []ServiceStackConnectedServiceStack

func (dto ServiceStackNginxConnectedStacks) MarshalJSON() ([]byte, error) {
	if dto == nil {
		return []byte("[]"), nil
	}
...
type ServiceStackNginxUserData []UserDataLight

func (dto ServiceStackNginxUserData) MarshalJSON() ([]byte, error) {
	if dto == nil {
		return []byte("[]"), nil
	}
