...
func (r DeleteBillingClientPaymentSourceResponse) Output() (output output.Success, err error) {
	return r.success, r.err
}

func (r DeleteBillingClientPaymentSourceResponse) Err() error {
	return r.err
}
func (r DeleteBillingClientPaymentSourceResponse) Headers() http.Header {
	return r.responseHeaders
}

func (r DeleteBillingClientPaymentSourceResponse) StatusCode() int {
...
func (h Handler) DeleteBillingClientPaymentSource(ctx context.Context, inputDtoPath path.ClientId, inputDtoBody body.DeleteBillingClientPaymentSource) (deleteBillingClientPaymentSourceResponse DeleteBillingClientPaymentSourceResponse, err error) {
	...
	var response DeleteBillingClientPaymentSourceResponse
