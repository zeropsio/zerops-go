...
func (r DeleteServiceStackBuildCacheResponse) Err() error {
	return r.err
}
func (r DeleteServiceStackBuildCacheResponse) Headers() http.Header {
	return r.responseHeaders
}

func (r DeleteServiceStackBuildCacheResponse) StatusCode() int {
...
func (h Handler) DeleteServiceStackBuildCache(ctx context.Context, inputDtoPath path.ServiceStackId) (deleteServiceStackBuildCacheResponse DeleteServiceStackBuildCacheResponse, err error) {
	u := "/api/rest/public/service-stack/" + inputDtoPath.Id.Native() + "/build-cache"

	var response DeleteServiceStackBuildCacheResponse
