...
func (r GetBillingClientStatusResponse) Err() error {
	return r.err
}
func (r GetBillingClientStatusResponse) Headers() http.Header {
...
func (h Handler) GetBillingClientStatus(ctx context.Context, inputDtoPath path.ClientId) (getBillingClientStatusResponse GetBillingClientStatusResponse, err error) {
	u := "/api/rest/public/billing/client/" + inputDtoPath.Id.Native() + "/status"

	var response GetBillingClientStatusResponse
