...
func (r GetCardPaymentSearchColumnsResponse) Err() error {
	return r.err
}
func (r GetCardPaymentSearchColumnsResponse) Headers() http.Header {
	return r.responseHeaders
}

func (r GetCardPaymentSearchColumnsResponse) StatusCode() int {
...
func (h Handler) GetCardPaymentSearchColumns(ctx context.Context) (getCardPaymentSearchColumnsResponse GetCardPaymentSearchColumnsResponse, err error) {
	u := "/api/rest/public/card-payment/search/columns"

	var response GetCardPaymentSearchColumnsResponse
