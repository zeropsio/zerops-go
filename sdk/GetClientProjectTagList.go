...
func (r GetClientProjectTagListResponse) Err() error {
	return r.err
}
func (r GetClientProjectTagListResponse) Headers() http.Header {
...
func (h Handler) GetClientProjectTagList(ctx context.Context, inputDtoPath path.ClientId) (getClientProjectTagListResponse GetClientProjectTagListResponse, err error) {
	u := "/api/rest/public/client/" + inputDtoPath.Id.Native() + "/project/tag/list"

	var response GetClientProjectTagListResponse
