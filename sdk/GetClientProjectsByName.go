...
func (r GetClientProjectsByNameResponse) Output() (output output.GetProjectsByName, err error) {
	return r.success, r.err
}

func (r GetClientProjectsByNameResponse) Err() error {
	return r.err
}
func (r GetClientProjectsByNameResponse) Headers() http.Header {
...
func (h Handler) GetClientProjectsByName(ctx context.Context, inputDtoPath path.GetProjectsByName) (getClientProjectsByNameResponse GetClientProjectsByNameResponse, err error) {
	u := "/api/rest/public/client/" + inputDtoPath.Id.Native() + "/projects-by-name/" + inputDtoPath.Name.Native() + ""

	var response GetClientProjectsByNameResponse
