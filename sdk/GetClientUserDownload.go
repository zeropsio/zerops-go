...
func (r GetClientUserDownloadResponse) Err() error {
	return r.err
}
func (r GetClientUserDownloadResponse) Headers() http.Header {
...
func (h Handler) GetClientUserDownload(ctx context.Context, inputDtoPath path.Generic) (getClientUserDownloadResponse GetClientUserDownloadResponse, err error) {
	u := "/api/rest/public/client-user/download/" + inputDtoPath.Id.Native() + ""

	var response GetClientUserDownloadResponse
