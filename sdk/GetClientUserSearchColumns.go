...
func (r GetClientUserSearchColumnsResponse) Err() error {
	return r.err
}
func (r GetClientUserSearchColumnsResponse) Headers() http.Header {
...
func (h Handler) GetClientUserSearchColumns(ctx context.Context) (getClientUserSearchColumnsResponse GetClientUserSearchColumnsResponse, err error) {
	u := "/api/rest/public/client-user/search/columns"

	var response GetClientUserSearchColumnsResponse
