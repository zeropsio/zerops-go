...
func (r GetClientVersionSearchNamesResponse) Err() error {
	return r.err
}
func (r GetClientVersionSearchNamesResponse) Headers() http.Header {
	return r.responseHeaders
}

func (r GetClientVersionSearchNamesResponse) StatusCode() int {
...
func (h Handler) GetClientVersionSearchNames(ctx context.Context) (getClientVersionSearchNamesResponse GetClientVersionSearchNamesResponse, err error) {
	u := "/api/rest/public/client-version/search/names"

	var response GetClientVersionSearchNamesResponse
