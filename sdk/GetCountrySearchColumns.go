...
func (r GetCountrySearchColumnsResponse) Err() error {
	return r.err
}
func (r GetCountrySearchColumnsResponse) Headers() http.Header {
...
func (h Handler) GetCountrySearchColumns(ctx context.Context) (getCountrySearchColumnsResponse GetCountrySearchColumnsResponse, err error) {
	u := "/api/rest/public/country/search/columns"

	var response GetCountrySearchColumnsResponse
