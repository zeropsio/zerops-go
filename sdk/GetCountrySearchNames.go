...
func (r GetCountrySearchNamesResponse) Err() error {
	return r.err
}
func (r GetCountrySearchNamesResponse) Headers() http.Header {
...
func (h Handler) GetCountrySearchNames(ctx context.Context) (getCountrySearchNamesResponse GetCountrySearchNamesResponse, err error) {
	u := "/api/rest/public/country/search/names"

	var response GetCountrySearchNamesResponse
