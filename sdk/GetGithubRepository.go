...
type GetGithubRepositoryResponse struct {
	success            output.VCSRepositoryList
	err                error
...
func (r GetGithubRepositoryResponse) Err() error {
	return r.err
}
func (r GetGithubRepositoryResponse) Headers() http.Header {
...
func (h Handler) GetGithubRepository(ctx context.Context) (getGithubRepositoryResponse GetGithubRepositoryResponse, err error) {
	u := "/api/rest/public/github/repository"

	var response GetGithubRepositoryResponse
