...
func (r GetGitlabRepositoryResponse) Err() error {
	return r.err
}
func (r GetGitlabRepositoryResponse) Headers() http.Header {
...
func (h Handler) GetGitlabRepository(ctx context.Context) (getGitlabRepositoryResponse GetGitlabRepositoryResponse, err error) {
	u := "/api/rest/public/gitlab/repository"

	var response GetGitlabRepositoryResponse
