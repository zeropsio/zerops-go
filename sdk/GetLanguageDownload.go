...
func (r GetLanguageDownloadResponse) Err() error {
	return r.err
}
func (r GetLanguageDownloadResponse) Headers() http.Header {
...
func (h Handler) GetLanguageDownload(ctx context.Context, inputDtoPath path.Generic) (getLanguageDownloadResponse GetLanguageDownloadResponse, err error) {
	u := "/api/rest/public/language/download/" + inputDtoPath.Id.Native() + ""

	var response GetLanguageDownloadResponse
