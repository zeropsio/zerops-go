...
func (r GetLanguageSearchColumnsResponse) Err() error {
	return r.err
}
func (r GetLanguageSearchColumnsResponse) Headers() http.Header {
...
func (h Handler) GetLanguageSearchColumns(ctx context.Context) (getLanguageSearchColumnsResponse GetLanguageSearchColumnsResponse, err error) {
	u := "/api/rest/public/language/search/columns"

	var response GetLanguageSearchColumnsResponse
