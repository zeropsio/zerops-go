...
func (r GetLanguageSearchNamesResponse) Err() error {
	return r.err
}
func (r GetLanguageSearchNamesResponse) Headers() http.Header {
...
func (h Handler) GetLanguageSearchNames(ctx context.Context) (getLanguageSearchNamesResponse GetLanguageSearchNamesResponse, err error) {
	u := "/api/rest/public/language/search/names"

	var response GetLanguageSearchNamesResponse
