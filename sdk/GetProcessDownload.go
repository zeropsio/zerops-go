...
func (r GetProcessDownloadResponse) Err() error {
	return r.err
}
func (r GetProcessDownloadResponse) Headers() http.Header {
...
func (h Handler) GetProcessDownload(ctx context.Context, inputDtoPath path.Generic) (getProcessDownloadResponse GetProcessDownloadResponse, err error) {
	u := "/api/rest/public/process/download/" + inputDtoPath.Id.Native() + ""

	var response GetProcessDownloadResponse
