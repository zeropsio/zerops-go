...
func (r GetProcessSearchNamesResponse) Err() error {
	return r.err
}
func (r GetProcessSearchNamesResponse) Headers() http.Header {
...
func (h Handler) GetProcessSearchNames(ctx context.Context) (getProcessSearchNamesResponse GetProcessSearchNamesResponse, err error) {
	u := "/api/rest/public/process/search/names"

	var response GetProcessSearchNamesResponse
