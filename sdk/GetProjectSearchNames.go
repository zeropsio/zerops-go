...
func (r GetProjectSearchNamesResponse) Err() error {
	return r.err
}
func (r GetProjectSearchNamesResponse) Headers() http.Header {
...
func (h Handler) GetProjectSearchNames(ctx context.Context) (getProjectSearchNamesResponse GetProjectSearchNamesResponse, err error) {
	u := "/api/rest/public/project/search/names"

	var response GetProjectSearchNamesResponse
