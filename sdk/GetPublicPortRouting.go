...
func (r GetPublicPortRoutingResponse) Output() (output output.PublicPortRouting, err error) {
	return r.success, r.err
}

func (r GetPublicPortRoutingResponse) Err() error {
	return r.err
}
func (r GetPublicPortRoutingResponse) Headers() http.Header {
...
func (h Handler) GetPublicPortRouting(ctx context.Context, inputDtoPath path.PublicPortRoutingId) (getPublicPortRoutingResponse GetPublicPortRoutingResponse, err error) {
	...
	var response GetPublicPortRoutingResponse
