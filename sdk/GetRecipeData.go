...
func (h Handler) GetRecipeData(ctx context.Context, inputDtoPath path.GetRecipeId, inputDtoQuery query.GetRecipeData) (getRecipeDataResponse GetRecipeDataResponse, err error) {
	u := "/api/rest/public/recipe/" + inputDtoPath.Id.Native() + "/data"
	...
	{
		param := inputDtoQuery.Branch.Native()
		queryParams = append(queryParams, "branch="+url.QueryEscape(param))
	}
	...
	var response GetRecipeDataResponse
