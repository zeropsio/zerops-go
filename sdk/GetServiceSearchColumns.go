...
func (r GetServiceSearchColumnsResponse) Err() error {
	return r.err
}
func (r GetServiceSearchColumnsResponse) Headers() http.Header {
...
func (h Handler) GetServiceSearchColumns(ctx context.Context) (getServiceSearchColumnsResponse GetServiceSearchColumnsResponse, err error) {
	u := "/api/rest/public/service/search/columns"

	var response GetServiceSearchColumnsResponse
