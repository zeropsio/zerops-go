...
func (r GetServiceSearchNamesResponse) Err() error {
	return r.err
}
func (r GetServiceSearchNamesResponse) Headers() http.Header {
...
func (h Handler) GetServiceSearchNames(ctx context.Context) (getServiceSearchNamesResponse GetServiceSearchNamesResponse, err error) {
	u := "/api/rest/public/service/search/names"

	var response GetServiceSearchNamesResponse
