...
func (r GetServiceStackByNameResponse) Err() error {
	return r.err
}
func (r GetServiceStackByNameResponse) Headers() http.Header {
...
func (h Handler) GetServiceStackByName(ctx context.Context, inputDtoPath path.GetServiceStackByName) (getServiceStackByNameResponse GetServiceStackByNameResponse, err error) {
	u := "/api/rest/public/service-stack-by-name/" + inputDtoPath.ProjectId.Native() + "/" + inputDtoPath.Name.Native() + ""

	var response GetServiceStackByNameResponse
