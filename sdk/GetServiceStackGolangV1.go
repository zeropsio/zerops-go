...
func (r GetServiceStackGolangV1Response) Err() error {
	return r.err
}
func (r GetServiceStackGolangV1Response) Headers() http.Header {
...
func (h Handler) GetServiceStackGolangV1(ctx context.Context, inputDtoPath path.ServiceStackId) (getServiceStackGolangV1Response GetServiceStackGolangV1Response, err error) {
	u := "/api/rest/public/service-stack/golang_v1/" + inputDtoPath.Id.Native() + ""

	var response GetServiceStackGolangV1Response
