...
func (r GetServiceStackMongodbV4Response) Err() error {
	return r.err
}
func (r GetServiceStackMongodbV4Response) Headers() http.Header {
...
func (h Handler) GetServiceStackMongodbV4(ctx context.Context, inputDtoPath path.ServiceStackId) (getServiceStackMongodbV4Response GetServiceStackMongodbV4Response, err error) {
	u := "/api/rest/public/service-stack/mongodb_v4/" + inputDtoPath.Id.Native() + ""

	var response GetServiceStackMongodbV4Response
