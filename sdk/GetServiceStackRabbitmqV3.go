...
func (r GetServiceStackRabbitmqV3Response) Output() (output output.ServiceStack, err error) {
	return r.success, r.err
}

func (r GetServiceStackRabbitmqV3Response) Err() error {
	return r.err
}
func (r GetServiceStackRabbitmqV3Response) Headers() http.Header {
...
func (h Handler) GetServiceStackRabbitmqV3(ctx context.Context, inputDtoPath path.ServiceStackId) (getServiceStackRabbitmqV3Response GetServiceStackRabbitmqV3Response, err error) {
	u := "/api/rest/public/service-stack/rabbitmq_v3/" + inputDtoPath.Id.Native() + ""

	var response GetServiceStackRabbitmqV3Response
