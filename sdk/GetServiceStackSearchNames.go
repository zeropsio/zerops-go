...
func (r GetServiceStackSearchNamesResponse) Err() error {
	return r.err
}
func (r GetServiceStackSearchNamesResponse) Headers() http.Header {
...
func (h Handler) GetServiceStackSearchNames(ctx context.Context) (getServiceStackSearchNamesResponse GetServiceStackSearchNamesResponse, err error) {
	u := "/api/rest/public/service-stack/search/names"

	var response GetServiceStackSearchNamesResponse
