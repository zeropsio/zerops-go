...
func (r GetUserDataDownloadResponse) Err() error {
	return r.err
}
func (r GetUserDataDownloadResponse) Headers() http.Header {
...
func (h Handler) GetUserDataDownload(ctx context.Context, inputDtoPath path.Generic) (getUserDataDownloadResponse GetUserDataDownloadResponse, err error) {
	u := "/api/rest/public/user-data/download/" + inputDtoPath.Id.Native() + ""

	var response GetUserDataDownloadResponse
