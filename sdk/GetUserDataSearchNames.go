...
func (r GetUserDataSearchNamesResponse) Err() error {
	return r.err
}
func (r GetUserDataSearchNamesResponse) Headers() http.Header {
...
func (h Handler) GetUserDataSearchNames(ctx context.Context) (getUserDataSearchNamesResponse GetUserDataSearchNamesResponse, err error) {
	u := "/api/rest/public/user-data/search/names"

	var response GetUserDataSearchNamesResponse
