...
func (r Post2FaLoginFinishResponse) Err() error {
	return r.err
}
func (r Post2FaLoginFinishResponse) Headers() http.Header {
...
func (h Handler) Post2FaLoginFinish(ctx context.Context, inputDtoBody body.WebAuthnLoginVerification) (post2FaLoginFinishResponse Post2FaLoginFinishResponse, err error) {
	u := "/api/rest/public/2fa/login/finish"

	var response Post2FaLoginFinishResponse
