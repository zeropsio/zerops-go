...
func (r Post2FaTotpRegistrationFinishResponse) Err() error {
	return r.err
}
func (r Post2FaTotpRegistrationFinishResponse) Headers() http.Header {
	return r.responseHeaders
}

func (r Post2FaTotpRegistrationFinishResponse) StatusCode() int {
...
func (h Handler) Post2FaTotpRegistrationFinish(ctx context.Context, inputDtoBody body.TotpRegistrationVerification) (post2FaTotpRegistrationFinishResponse Post2FaTotpRegistrationFinishResponse, err error) {
	u := "/api/rest/public/2fa/totp/registration/finish"

	var response Post2FaTotpRegistrationFinishResponse
