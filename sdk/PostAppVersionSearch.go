...
type PostAppVersionSearchResponse struct {
	success            output.EsAppVersionResponse
	err                error
...
func (r PostAppVersionSearchResponse) Output() (output output.EsAppVersionResponse, err error) {
	return r.success, r.err
}

func (r PostAppVersionSearchResponse) Err() error {
	return r.err
}
func (r PostAppVersionSearchResponse) Headers() http.Header {
...
func (h Handler) PostAppVersionSearch(ctx context.Context, inputDtoBody body.EsFilter) (postAppVersionSearchResponse PostAppVersionSearchResponse, err error) {
	u := "/api/rest/public/app-version/search"

	var response PostAppVersionSearchResponse
