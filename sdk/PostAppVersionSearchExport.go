...
func (r PostAppVersionSearchExportResponse) Err() error {
	return r.err
}
func (r PostAppVersionSearchExportResponse) Headers() http.Header {
...
func (h Handler) PostAppVersionSearchExport(ctx context.Context, inputDtoBody body.EsExport) (postAppVersionSearchExportResponse PostAppVersionSearchExportResponse, err error) {
	u := "/api/rest/public/app-version/search/export"

	var response PostAppVersionSearchExportResponse
