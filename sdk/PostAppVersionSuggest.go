...
func (r PostAppVersionSuggestResponse) Err() error {
	return r.err
}
func (r PostAppVersionSuggestResponse) Headers() http.Header {
...
func (h Handler) PostAppVersionSuggest(ctx context.Context, inputDtoBody body.EsSuggest) (postAppVersionSuggestResponse PostAppVersionSuggestResponse, err error) {
	u := "/api/rest/public/app-version/suggest"

	var response PostAppVersionSuggestResponse
