...
func (r PostBillingClientPaymentResponse) Err() error {
	return r.err
}
func (r PostBillingClientPaymentResponse) Headers() http.Header {
...
func (h Handler) PostBillingClientPayment(ctx context.Context, inputDtoPath path.ClientId, inputDtoBody body.PostBillingPayment) (postBillingClientPaymentResponse PostBillingClientPaymentResponse, err error) {
	u := "/api/rest/public/billing/client/" + inputDtoPath.Id.Native() + "/payment"

	var response PostBillingClientPaymentResponse
