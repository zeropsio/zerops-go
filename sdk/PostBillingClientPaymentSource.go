...
func (r PostBillingClientPaymentSourceResponse) Output() (output output.ClientSecret, err error) {
	return r.success, r.err
}

func (r PostBillingClientPaymentSourceResponse) Err() error {
	return r.err
}
func (r PostBillingClientPaymentSourceResponse) Headers() http.Header {
	return r.responseHeaders
}

func (r PostBillingClientPaymentSourceResponse) StatusCode() int {
...
func (h Handler) PostBillingClientPaymentSource(ctx context.Context, inputDtoPath path.ClientId) (postBillingClientPaymentSourceResponse PostBillingClientPaymentSourceResponse, err error) {
	...
	var response PostBillingClientPaymentSourceResponse
