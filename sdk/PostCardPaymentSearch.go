...
func (r PostCardPaymentSearchResponse) Output() (output output.EsCardPaymentResponse, err error) {
	return r.success, r.err
}

func (r PostCardPaymentSearchResponse) Err() error {
	return r.err
}
func (r PostCardPaymentSearchResponse) Headers() http.Header {
...
func (h Handler) PostCardPaymentSearch(ctx context.Context, inputDtoBody body.EsFilter) (postCardPaymentSearchResponse PostCardPaymentSearchResponse, err error) {
	u := "/api/rest/public/card-payment/search"

	var response PostCardPaymentSearchResponse
