...
func (r PostCardPaymentSearchExportResponse) Err() error {
	return r.err
}
func (r PostCardPaymentSearchExportResponse) Headers() http.Header {
	return r.responseHeaders
}

func (r PostCardPaymentSearchExportResponse) StatusCode() int {
...
func (h Handler) PostCardPaymentSearchExport(ctx context.Context, inputDtoBody body.EsExport) (postCardPaymentSearchExportResponse PostCardPaymentSearchExportResponse, err error) {
	u := "/api/rest/public/card-payment/search/export"

	var response PostCardPaymentSearchExportResponse
