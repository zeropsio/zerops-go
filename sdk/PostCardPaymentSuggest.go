...
func (r PostCardPaymentSuggestResponse) Err() error {
	return r.err
}
func (r PostCardPaymentSuggestResponse) Headers() http.Header {
...
func (h Handler) PostCardPaymentSuggest(ctx context.Context, inputDtoBody body.EsSuggest) (postCardPaymentSuggestResponse PostCardPaymentSuggestResponse, err error) {
	u := "/api/rest/public/card-payment/suggest"

	var response PostCardPaymentSuggestResponse
