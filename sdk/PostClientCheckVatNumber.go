...
func (r PostClientCheckVatNumberResponse) Err() error {
	return r.err
}
func (r PostClientCheckVatNumberResponse) Headers() http.Header {
...
func (h Handler) PostClientCheckVatNumber(ctx context.Context, inputDtoBody body.PostClientCheckVAT) (postClientCheckVatNumberResponse PostClientCheckVatNumberResponse, err error) {
	u := "/api/rest/public/client/check-vat-number"

	var response PostClientCheckVatNumberResponse
