...
func (r PostClientIntegrationTokenResponse) Output() (output output.ClientIntegrationTokenRaw, err error) {
	return r.success, r.err
}

func (r PostClientIntegrationTokenResponse) Err() error {
	return r.err
}
func (r PostClientIntegrationTokenResponse) Headers() http.Header {
...
func (h Handler) PostClientIntegrationToken(ctx context.Context, inputDtoPath path.ClientId, inputDtoBody body.ClientIntegrationToken) (postClientIntegrationTokenResponse PostClientIntegrationTokenResponse, err error) {
	u := "/api/rest/public/client/" + inputDtoPath.Id.Native() + "/integration-token"

	var response PostClientIntegrationTokenResponse
