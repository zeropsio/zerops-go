...
func (r PostClientProjectImportResponse) Err() error {
	return r.err
}
func (r PostClientProjectImportResponse) Headers() http.Header {
...
func (h Handler) PostClientProjectImport(ctx context.Context, inputDtoPath path.ClientId, inputDtoBody body.ProjectImport) (postClientProjectImportResponse PostClientProjectImportResponse, err error) {
	u := "/api/rest/public/client/" + inputDtoPath.Id.Native() + "/project/import"

	var response PostClientProjectImportResponse
