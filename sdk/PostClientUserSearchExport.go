...
func (r PostClientUserSearchExportResponse) Err() error {
	return r.err
}
func (r PostClientUserSearchExportResponse) Headers() http.Header {
...
func (h Handler) PostClientUserSearchExport(ctx context.Context, inputDtoBody body.EsExport) (postClientUserSearchExportResponse PostClientUserSearchExportResponse, err error) {
	u := "/api/rest/public/client-user/search/export"

	var response PostClientUserSearchExportResponse
