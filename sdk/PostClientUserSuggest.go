...
func (r PostClientUserSuggestResponse) Err() error {
	return r.err
}
func (r PostClientUserSuggestResponse) Headers() http.Header {
...
func (h Handler) PostClientUserSuggest(ctx context.Context, inputDtoBody body.EsSuggest) (postClientUserSuggestResponse PostClientUserSuggestResponse, err error) {
	u := "/api/rest/public/client-user/suggest"

	var response PostClientUserSuggestResponse
