...
func (r PostClientVersionSuggestResponse) Err() error {
	return r.err
}
func (r PostClientVersionSuggestResponse) Headers() http.Header {
...
func (h Handler) PostClientVersionSuggest(ctx context.Context, inputDtoBody body.EsSuggest) (postClientVersionSuggestResponse PostClientVersionSuggestResponse, err error) {
	u := "/api/rest/public/client-version/suggest"

	var response PostClientVersionSuggestResponse
