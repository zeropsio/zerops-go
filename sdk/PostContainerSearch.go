...
type PostContainerSearchResponse struct {
	success            output.EsContainerResponse
	err                error
...
func (r PostContainerSearchResponse) Output() (output output.EsContainerResponse, err error) {
	return r.success, r.err
}

func (r PostContainerSearchResponse) Err() error {
	return r.err
}
func (r PostContainerSearchResponse) Headers() http.Header {
...
func (h Handler) PostContainerSearch(ctx context.Context, inputDtoBody body.EsFilter) (postContainerSearchResponse PostContainerSearchResponse, err error) {
	u := "/api/rest/public/container/search"

	var response PostContainerSearchResponse
