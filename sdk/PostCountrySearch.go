...
type PostCountrySearchResponse struct {
	success            output.EsCountryResponse
	err                error
...
func (r PostCountrySearchResponse) Err() error {
	return r.err
}
func (r PostCountrySearchResponse) Headers() http.Header {
...
func (h Handler) PostCountrySearch(ctx context.Context, inputDtoBody body.EsFilter) (postCountrySearchResponse PostCountrySearchResponse, err error) {
	u := "/api/rest/public/country/search"

	var response PostCountrySearchResponse
