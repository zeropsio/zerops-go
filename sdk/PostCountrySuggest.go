...
func (r PostCountrySuggestResponse) Err() error {
	return r.err
}
func (r PostCountrySuggestResponse) Headers() http.Header {
...
func (h Handler) PostCountrySuggest(ctx context.Context, inputDtoBody body.EsSuggest) (postCountrySuggestResponse PostCountrySuggestResponse, err error) {
	u := "/api/rest/public/country/suggest"

	var response PostCountrySuggestResponse
