...
func (r PostCurrencySearchExportResponse) Err() error {
	return r.err
}
func (r PostCurrencySearchExportResponse) Headers() http.Header {
...
func (h Handler) PostCurrencySearchExport(ctx context.Context, inputDtoBody body.EsExport) (postCurrencySearchExportResponse PostCurrencySearchExportResponse, err error) {
	u := "/api/rest/public/currency/search/export"

	var response PostCurrencySearchExportResponse
