...
func (r PostCurrencySuggestResponse) Err() error {
	return r.err
}
func (r PostCurrencySuggestResponse) Headers() http.Header {
...
func (h Handler) PostCurrencySuggest(ctx context.Context, inputDtoBody body.EsSuggest) (postCurrencySuggestResponse PostCurrencySuggestResponse, err error) {
	u := "/api/rest/public/currency/suggest"

	var response PostCurrencySuggestResponse
