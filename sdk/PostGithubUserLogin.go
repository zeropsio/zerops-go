...
func (r PostGithubUserLoginResponse) Err() error {
	return r.err
}
func (r PostGithubUserLoginResponse) Headers() http.Header {
...
func (h Handler) PostGithubUserLogin(ctx context.Context, inputDtoBody body.GithubAuth) (postGithubUserLoginResponse PostGithubUserLoginResponse, err error) {
	u := "/api/rest/public/github/user-login"

	var response PostGithubUserLoginResponse
