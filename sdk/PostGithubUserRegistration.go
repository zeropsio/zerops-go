...
func (r PostGithubUserRegistrationResponse) Err() error {
	return r.err
}
func (r PostGithubUserRegistrationResponse) Headers() http.Header {
...
func (h Handler) PostGithubUserRegistration(ctx context.Context, inputDtoBody body.GithubAuth) (postGithubUserRegistrationResponse PostGithubUserRegistrationResponse, err error) {
	u := "/api/rest/public/github/user-registration"

	var response PostGithubUserRegistrationResponse
