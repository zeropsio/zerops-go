...
func (r PostGitlabUserRegistrationResponse) Err() error {
	return r.err
}
func (r PostGitlabUserRegistrationResponse) Headers() http.Header {
...
func (h Handler) PostGitlabUserRegistration(ctx context.Context, inputDtoBody body.GitlabAuth) (postGitlabUserRegistrationResponse PostGitlabUserRegistrationResponse, err error) {
	u := "/api/rest/public/gitlab/user-registration"

	var response PostGitlabUserRegistrationResponse
