...
type PostProcessSearchResponse struct {
	success            output.EsProcessResponse
	err                error
...
func (r PostProcessSearchResponse) Err() error {
	return r.err
}
func (r PostProcessSearchResponse) Headers() http.Header {
...
func (h Handler) PostProcessSearch(ctx context.Context, inputDtoBody body.EsFilter) (postProcessSearchResponse PostProcessSearchResponse, err error) {
	u := "/api/rest/public/process/search"

	var response PostProcessSearchResponse
