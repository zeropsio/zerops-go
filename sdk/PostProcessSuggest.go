...
func (r PostProcessSuggestResponse) Err() error {
	return r.err
}
func (r PostProcessSuggestResponse) Headers() http.Header {
...
func (h Handler) PostProcessSuggest(ctx context.Context, inputDtoBody body.EsSuggest) (postProcessSuggestResponse PostProcessSuggestResponse, err error) {
	u := "/api/rest/public/process/suggest"

	var response PostProcessSuggestResponse
