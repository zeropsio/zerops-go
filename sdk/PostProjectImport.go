...
func (r PostProjectImportResponse) Err() error {
	return r.err
}
func (r PostProjectImportResponse) Headers() http.Header {
...
func (h Handler) PostProjectImport(ctx context.Context, inputDtoBody body.ProjectImport) (postProjectImportResponse PostProjectImportResponse, err error) {
	u := "/api/rest/public/project/import"

	var response PostProjectImportResponse
