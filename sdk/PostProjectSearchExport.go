...
func (r PostProjectSearchExportResponse) Err() error {
	return r.err
}
func (r PostProjectSearchExportResponse) Headers() http.Header {
...
func (h Handler) PostProjectSearchExport(ctx context.Context, inputDtoBody body.EsExport) (postProjectSearchExportResponse PostProjectSearchExportResponse, err error) {
	u := "/api/rest/public/project/search/export"

	var response PostProjectSearchExportResponse
