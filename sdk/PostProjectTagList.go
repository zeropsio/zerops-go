...
func (r PostProjectTagListResponse) Err() error {
	return r.err
}
func (r PostProjectTagListResponse) Headers() http.Header {
...
func (h Handler) PostProjectTagList(ctx context.Context, inputDtoBody body.PostProjectTagList) (postProjectTagListResponse PostProjectTagListResponse, err error) {
	u := "/api/rest/public/project/tag/list"

	var response PostProjectTagListResponse
