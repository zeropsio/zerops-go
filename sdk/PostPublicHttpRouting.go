...
func (r PostPublicHttpRoutingResponse) Output() (output output.PublicHttpRouting, err error) {
	return r.success, r.err
}

func (r PostPublicHttpRoutingResponse) Err() error {
	return r.err
}
func (r PostPublicHttpRoutingResponse) Headers() http.Header {
...
func (h Handler) PostPublicHttpRouting(ctx context.Context, inputDtoBody body.PublicHttpRoutingPost) (postPublicHttpRoutingResponse PostPublicHttpRoutingResponse, err error) {
	u := "/api/rest/public/public-http-routing"

	var response PostPublicHttpRoutingResponse
