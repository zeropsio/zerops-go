...
func (r PostPublicPortRoutingResponse) Output() (output output.PublicPortRouting, err error) {
	return r.success, r.err
}

func (r PostPublicPortRoutingResponse) Err() error {
	return r.err
}
func (r PostPublicPortRoutingResponse) Headers() http.Header {
...
func (h Handler) PostPublicPortRouting(ctx context.Context, inputDtoBody body.PublicPortRoutingPost) (postPublicPortRoutingResponse PostPublicPortRoutingResponse, err error) {
	u := "/api/rest/public/public-port-routing"

	var response PostPublicPortRoutingResponse
