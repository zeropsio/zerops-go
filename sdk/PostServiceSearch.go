...
type PostServiceSearchResponse struct {
	success            output.EsServiceResponse
	err                error
...
func (r PostServiceSearchResponse) Err() error {
	return r.err
}
func (r PostServiceSearchResponse) Headers() http.Header {
...
func (h Handler) PostServiceSearch(ctx context.Context, inputDtoBody body.EsFilter) (postServiceSearchResponse PostServiceSearchResponse, err error) {
	u := "/api/rest/public/service/search"

	var response PostServiceSearchResponse
