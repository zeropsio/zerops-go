...
func (r PostServiceStackAppVersionResponse) Output() (output output.PostAppVersion, err error) {
	return r.success, r.err
}

func (r PostServiceStackAppVersionResponse) Err() error {
	return r.err
}
func (r PostServiceStackAppVersionResponse) Headers() http.Header {
...
func (h Handler) PostServiceStackAppVersion(ctx context.Context, inputDtoPath path.ServiceStackId, inputDtoBody body.PostAppVersion) (postServiceStackAppVersionResponse PostServiceStackAppVersionResponse, err error) {
	...
	var response PostServiceStackAppVersionResponse
