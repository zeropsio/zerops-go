...
func (r PostServiceStackGithubWebhookResponse) Err() error {
	return r.err
}
func (r PostServiceStackGithubWebhookResponse) Headers() http.Header {
	return r.responseHeaders
}

func (r PostServiceStackGithubWebhookResponse) StatusCode() int {
...
func (h Handler) PostServiceStackGithubWebhook(ctx context.Context, inputDtoPath path.ServiceStackId) (postServiceStackGithubWebhookResponse PostServiceStackGithubWebhookResponse, err error) {
	u := "/api/rest/public/service-stack/" + inputDtoPath.Id.Native() + "/github-webhook"

	var response PostServiceStackGithubWebhookResponse
