...
func (r PostServiceStackGitlabWebhookResponse) Err() error {
	return r.err
}
func (r PostServiceStackGitlabWebhookResponse) Headers() http.Header {
	return r.responseHeaders
}

func (r PostServiceStackGitlabWebhookResponse) StatusCode() int {
...
func (h Handler) PostServiceStackGitlabWebhook(ctx context.Context, inputDtoPath path.ServiceStackId) (postServiceStackGitlabWebhookResponse PostServiceStackGitlabWebhookResponse, err error) {
	u := "/api/rest/public/service-stack/" + inputDtoPath.Id.Native() + "/gitlab-webhook"

	var response PostServiceStackGitlabWebhookResponse
