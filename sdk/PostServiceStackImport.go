...
func (r PostServiceStackImportResponse) Err() error {
	return r.err
}
func (r PostServiceStackImportResponse) Headers() http.Header {
...
func (h Handler) PostServiceStackImport(ctx context.Context, inputDtoBody body.ServiceStackImport) (postServiceStackImportResponse PostServiceStackImportResponse, err error) {
	u := "/api/rest/public/service-stack/import"

	var response PostServiceStackImportResponse
