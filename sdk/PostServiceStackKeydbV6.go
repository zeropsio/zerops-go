...
func (r PostServiceStackKeydbV6Response) Output() (output output.ServiceStackProcess, err error) {
	return r.success, r.err
}

func (r PostServiceStackKeydbV6Response) Err() error {
	return r.err
}
func (r PostServiceStackKeydbV6Response) Headers() http.Header {
...
func (h Handler) PostServiceStackKeydbV6(ctx context.Context, inputDtoBody body.PostStandardServiceStack) (postServiceStackKeydbV6Response PostServiceStackKeydbV6Response, err error) {
	u := "/api/rest/public/service-stack/keydb_v6"

	var response PostServiceStackKeydbV6Response
