...
func (r PostServiceStackMongodbV4Response) Output() (output output.ServiceStackProcess, err error) {
	return r.success, r.err
}

func (r PostServiceStackMongodbV4Response) Err() error {
	return r.err
}
func (r PostServiceStackMongodbV4Response) Headers() http.Header {
...
func (h Handler) PostServiceStackMongodbV4(ctx context.Context, inputDtoBody body.PostStandardServiceStack) (postServiceStackMongodbV4Response PostServiceStackMongodbV4Response, err error) {
	u := "/api/rest/public/service-stack/mongodb_v4"

	var response PostServiceStackMongodbV4Response
