...
func (r PostServiceStackNginxV120Response) Output() (output output.ServiceStackProcessNginx, err error) {
	return r.success, r.err
}

func (r PostServiceStackNginxV120Response) Err() error {
	return r.err
}
func (r PostServiceStackNginxV120Response) Headers() http.Header {
...
func (h Handler) PostServiceStackNginxV120(ctx context.Context, inputDtoBody body.PostUserNginxServiceStack) (postServiceStackNginxV120Response PostServiceStackNginxV120Response, err error) {
	u := "/api/rest/public/service-stack/nginx_v1_20"

	var response PostServiceStackNginxV120Response
