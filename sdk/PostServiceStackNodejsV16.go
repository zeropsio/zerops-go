...
func (r PostServiceStackNodejsV16Response) Output() (output output.ServiceStackProcess, err error) {
	return r.success, r.err
}

func (r PostServiceStackNodejsV16Response) Err() error {
	return r.err
}
func (r PostServiceStackNodejsV16Response) Headers() http.Header {
...
func (h Handler) PostServiceStackNodejsV16(ctx context.Context, inputDtoBody body.PostUserRuntimeServiceStack) (postServiceStackNodejsV16Response PostServiceStackNodejsV16Response, err error) {
	u := "/api/rest/public/service-stack/nodejs_v16"

	var response PostServiceStackNodejsV16Response
