...
func (r PostServiceStackSearchExportResponse) Err() error {
	return r.err
}
func (r PostServiceStackSearchExportResponse) Headers() http.Header {
	return r.responseHeaders
}

func (r PostServiceStackSearchExportResponse) StatusCode() int {
...
func (h Handler) PostServiceStackSearchExport(ctx context.Context, inputDtoBody body.EsExport) (postServiceStackSearchExportResponse PostServiceStackSearchExportResponse, err error) {
	u := "/api/rest/public/service-stack/search/export"

	var response PostServiceStackSearchExportResponse
