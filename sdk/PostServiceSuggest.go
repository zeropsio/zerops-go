...
func (r PostServiceSuggestResponse) Err() error {
	return r.err
}
func (r PostServiceSuggestResponse) Headers() http.Header {
...
func (h Handler) PostServiceSuggest(ctx context.Context, inputDtoBody body.EsSuggest) (postServiceSuggestResponse PostServiceSuggestResponse, err error) {
	u := "/api/rest/public/service/suggest"

	var response PostServiceSuggestResponse
