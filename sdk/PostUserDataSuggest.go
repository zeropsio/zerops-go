...
func (r PostUserDataSuggestResponse) Err() error {
	return r.err
}
func (r PostUserDataSuggestResponse) Headers() http.Header {
...
func (h Handler) PostUserDataSuggest(ctx context.Context, inputDtoBody body.EsSuggest) (postUserDataSuggestResponse PostUserDataSuggestResponse, err error) {
	u := "/api/rest/public/user-data/suggest"

	var response PostUserDataSuggestResponse
