...
func (r PostWebauthnLoginFinishResponse) Err() error {
	return r.err
}
func (r PostWebauthnLoginFinishResponse) Headers() http.Header {
...
func (h Handler) PostWebauthnLoginFinish(ctx context.Context, inputDtoBody body.WebAuthnLoginVerification) (postWebauthnLoginFinishResponse PostWebauthnLoginFinishResponse, err error) {
	u := "/api/rest/public/webauthn/login/finish"

	var response PostWebauthnLoginFinishResponse
