...
func (r PutClientBillingInfoResponse) Err() error {
	return r.err
}
func (r PutClientBillingInfoResponse) Headers() http.Header {
...
func (h Handler) PutClientBillingInfo(ctx context.Context, inputDtoPath path.ClientId, inputDtoBody body.PutClientBillingInfo) (putClientBillingInfoResponse PutClientBillingInfoResponse, err error) {
	u := "/api/rest/public/client/" + inputDtoPath.Id.Native() + "/billing-info"

	var response PutClientBillingInfoResponse
