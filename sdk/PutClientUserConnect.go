...
func (r PutClientUserConnectResponse) Err() error {
	return r.err
}
func (r PutClientUserConnectResponse) Headers() http.Header {
...
func (h Handler) PutClientUserConnect(ctx context.Context, inputDtoPath path.ClientId, inputDtoBody body.ClientUser) (putClientUserConnectResponse PutClientUserConnectResponse, err error) {
	u := "/api/rest/public/client/" + inputDtoPath.Id.Native() + "/user/connect"

	var response PutClientUserConnectResponse
