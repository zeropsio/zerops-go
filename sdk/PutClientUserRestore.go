...
func (r PutClientUserRestoreResponse) Err() error {
	return r.err
}
func (r PutClientUserRestoreResponse) Headers() http.Header {
...
func (h Handler) PutClientUserRestore(ctx context.Context, inputDtoPath path.ClientUserId) (putClientUserRestoreResponse PutClientUserRestoreResponse, err error) {
	u := "/api/rest/public/client-user/" + inputDtoPath.Id.Native() + "/restore"

	var response PutClientUserRestoreResponse
