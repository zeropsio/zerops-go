...
func (r PutProjectEnvEnvFileResponse) Err() error {
	return r.err
}
func (r PutProjectEnvEnvFileResponse) Headers() http.Header {
...
func (h Handler) PutProjectEnvEnvFile(ctx context.Context, inputDtoBody body.ProjectEnvPutEnvFile) (putProjectEnvEnvFileResponse PutProjectEnvEnvFileResponse, err error) {
	u := "/api/rest/public/project-env/env-file"

	var response PutProjectEnvEnvFileResponse
