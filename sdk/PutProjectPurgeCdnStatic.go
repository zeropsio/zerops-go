...
func (r PutProjectPurgeCdnStaticResponse) Err() error {
	return r.err
}
func (r PutProjectPurgeCdnStaticResponse) Headers() http.Header {
...
func (h Handler) PutProjectPurgeCdnStatic(ctx context.Context, inputDtoPath path.CdnPurgeUrl) (putProjectPurgeCdnStaticResponse PutProjectPurgeCdnStaticResponse, err error) {
	u := "/api/rest/public/project/" + inputDtoPath.Id.Native() + "/purge-cdn/static/" + inputDtoPath.Domain.Native() + "/{path:.*}"

	var response PutProjectPurgeCdnStaticResponse
