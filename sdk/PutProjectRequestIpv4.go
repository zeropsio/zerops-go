...
func (r PutProjectRequestIpv4Response) Err() error {
	return r.err
}
func (r PutProjectRequestIpv4Response) Headers() http.Header {
...
func (h Handler) PutProjectRequestIpv4(ctx context.Context, inputDtoPath path.ProjectId) (putProjectRequestIpv4Response PutProjectRequestIpv4Response, err error) {
	u := "/api/rest/public/project/" + inputDtoPath.Id.Native() + "/request-ipv4"

	var response PutProjectRequestIpv4Response
