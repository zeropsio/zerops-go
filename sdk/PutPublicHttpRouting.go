...
func (r PutPublicHttpRoutingResponse) Output() (output output.PublicHttpRouting, err error) {
	return r.success, r.err
}

func (r PutPublicHttpRoutingResponse) Err() error {
	return r.err
}
func (r PutPublicHttpRoutingResponse) Headers() http.Header {
...
func (h Handler) PutPublicHttpRouting(ctx context.Context, inputDtoPath path.PublicHttpRoutingId, inputDtoBody body.PublicHttpRoutingPut) (putPublicHttpRoutingResponse PutPublicHttpRoutingResponse, err error) {
	...
	var response PutPublicHttpRoutingResponse
