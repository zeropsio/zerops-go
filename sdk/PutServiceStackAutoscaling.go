...
func (r PutServiceStackAutoscalingResponse) Err() error {
	return r.err
}
func (r PutServiceStackAutoscalingResponse) Headers() http.Header {
...
func (h Handler) PutServiceStackAutoscaling(ctx context.Context, inputDtoPath path.ServiceStackId, inputDtoBody body.Autoscaling) (putServiceStackAutoscalingResponse PutServiceStackAutoscalingResponse, err error) {
	u := "/api/rest/public/service-stack/" + inputDtoPath.Id.Native() + "/autoscaling"

	var response PutServiceStackAutoscalingResponse
