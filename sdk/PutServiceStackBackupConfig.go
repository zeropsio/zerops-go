...
func (r PutServiceStackBackupConfigResponse) Err() error {
	return r.err
}
func (r PutServiceStackBackupConfigResponse) Headers() http.Header {
	return r.responseHeaders
}

func (r PutServiceStackBackupConfigResponse) StatusCode() int {
...
func (h Handler) PutServiceStackBackupConfig(ctx context.Context, inputDtoPath path.ServiceStackId, inputDtoBody body.ServiceStackBackupConfig) (putServiceStackBackupConfigResponse PutServiceStackBackupConfigResponse, err error) {
	u := "/api/rest/public/service-stack/" + inputDtoPath.Id.Native() + "/backup-config"

	var response PutServiceStackBackupConfigResponse
