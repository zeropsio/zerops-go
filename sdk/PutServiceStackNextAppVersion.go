...
func (r PutServiceStackNextAppVersionResponse) Err() error {
	return r.err
}
func (r PutServiceStackNextAppVersionResponse) Headers() http.Header {
	return r.responseHeaders
}

func (r PutServiceStackNextAppVersionResponse) StatusCode() int {
...
func (h Handler) PutServiceStackNextAppVersion(ctx context.Context, inputDtoPath path.ServiceStackId, inputDtoBody body.ServiceStackNextAppVersion) (putServiceStackNextAppVersionResponse PutServiceStackNextAppVersionResponse, err error) {
	u := "/api/rest/public/service-stack/" + inputDtoPath.Id.Native() + "/next-app-version"

	var response PutServiceStackNextAppVersionResponse
