...
func (r PutServiceStackPortsResponse) Err() error {
	return r.err
}
func (r PutServiceStackPortsResponse) Headers() http.Header {
...
func (h Handler) PutServiceStackPorts(ctx context.Context, inputDtoPath path.ServiceStackId, inputDtoBody body.PutServiceStackPorts) (putServiceStackPortsResponse PutServiceStackPortsResponse, err error) {
	u := "/api/rest/public/service-stack/" + inputDtoPath.Id.Native() + "/ports"

	var response PutServiceStackPortsResponse
