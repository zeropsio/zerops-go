...
func (r PutServiceStackStartResponse) Err() error {
	return r.err
}
func (r PutServiceStackStartResponse) Headers() http.Header {
...
func (h Handler) PutServiceStackStart(ctx context.Context, inputDtoPath path.ServiceStackId) (putServiceStackStartResponse PutServiceStackStartResponse, err error) {
	u := "/api/rest/public/service-stack/" + inputDtoPath.Id.Native() + "/start"

	var response PutServiceStackStartResponse
