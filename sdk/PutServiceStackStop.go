...
func (r PutServiceStackStopResponse) Err() error {
	return r.err
}
func (r PutServiceStackStopResponse) Headers() http.Header {
...
func (h Handler) PutServiceStackStop(ctx context.Context, inputDtoPath path.ServiceStackId) (putServiceStackStopResponse PutServiceStackStopResponse, err error) {
	u := "/api/rest/public/service-stack/" + inputDtoPath.Id.Native() + "/stop"

	var response PutServiceStackStopResponse
