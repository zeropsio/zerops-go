...
func (r PutServiceStackUserDataEnvFileResponse) Output() (output output.Process, err error) {
	return r.success, r.err
}

func (r PutServiceStackUserDataEnvFileResponse) Err() error {
	return r.err
}
func (r PutServiceStackUserDataEnvFileResponse) Headers() http.Header {
	return r.responseHeaders
}

func (r PutServiceStackUserDataEnvFileResponse) StatusCode() int {
...
func (h Handler) PutServiceStackUserDataEnvFile(ctx context.Context, inputDtoPath path.ServiceStackId, inputDtoBody body.UserDataPutEnvFile) (putServiceStackUserDataEnvFileResponse PutServiceStackUserDataEnvFileResponse, err error) {
	...
	var response PutServiceStackUserDataEnvFileResponse
