...
func (r PutUserPasswordViaTokenResponse) Err() error {
	return r.err
}
func (r PutUserPasswordViaTokenResponse) Headers() http.Header {
...
func (h Handler) PutUserPasswordViaToken(ctx context.Context, inputDtoBody body.UserPutPasswordViaToken) (putUserPasswordViaTokenResponse PutUserPasswordViaTokenResponse, err error) {
	u := "/api/rest/public/user/password-via-token"

	var response PutUserPasswordViaTokenResponse
